...
public class BrbranchService : ServiceBase<Brbranch, int>, IBrbranchService
{
    public BrbranchService(IBrbranchRepository repository, ICoreProvider coreProvider) : base(repository, coreProvider)
    {
    }
}