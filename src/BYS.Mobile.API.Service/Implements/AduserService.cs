...
public class AduserService : ServiceBase<Aduser, int>, IAduserService
{
    public AduserService(IAduserRepository repository, ICoreProvider coreProvider) : base(repository, coreProvider)
    {
    }
}